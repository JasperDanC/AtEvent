...
// import 'package:at_event/models/hybrid_notification_model.dart';
// import 'package:at_event/utils/init_events_service.dart';
...
//     } else {
//       eventNotificationModel = EventNotificationModel();
//       eventNotificationModel.setting = Setting();
...
//       if (eventData.isUpdating != null && eventData.isUpdating == false) {
//         // new event received
//         // show dialog
//         // add in event list
//         addNewEventInEventList(eventData);
//       } else if (eventData.isUpdating) {
...
//       });
//     });
//     presentEventData.isUpdating = true;
//
...
//     var result;
//     if (isEventUpdate) {
//       eventNotificationModel.isUpdating = true;
...
//     eventNotification.isUpdating = false;
...
//       return 'add title';
//     } else if (eventData.setting == null ||
//         eventData.setting.label == null ||
//         eventData.setting.latitude == null ||
//         eventData.setting.longitude == null) {
//       return 'add venue';
//     } else if (eventData.event.isRecurring == null) {
//       return 'select event type';
//     } else if (eventData.event.isRecurring == false &&
//         checkForOneDayEventFormValidation(eventData) is String) {
//       return checkForOneDayEventFormValidation(eventData);
//     } else if (eventData.event.isRecurring == true &&
//         checkForRecurringDayEventFormValidation(eventData) is String) {
//       return checkForRecurringDayEventFormValidation(eventData);
//     } else {
//       return true;
//     }
//   }
//
//   dynamic checkForOneDayEventFormValidation(EventNotificationModel eventData) {
...
//         0) {
//       print(
//           'validation eventData.event.startTime ${eventData.event.startTime}');
//       print('validation eventData.event.endTime ${eventData.event.endTime}');
//
...
//   }
//
//   dynamic checkForRecurringDayEventFormValidation(
//       EventNotificationModel eventData) {
